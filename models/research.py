...
class ResearchMaterial(I18nModel):
    ...
    summary: Optional[str] = Field(
        default=None,
        description="Summary of the material content"
    )
    keywords: List[str] = Field(
        default_factory=list,
        description="Keywords related to this material"
    )
    key_findings: List[str] = Field(
        default_factory=list,
        description="Key findings or main points from this material"
    )
    ...
    related_documents: List[Dict[str, Any]] = Field(
        default_factory=list,
        description="Related documents found through vector similarity"
    )
